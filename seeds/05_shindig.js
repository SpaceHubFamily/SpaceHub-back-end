  ...
  return knex('shindig').del()
    .then(function () {
      ...
      return knex('shindig').insert([
        ...
        {date: "09/15/2017", available: true, start_time: '4:45', end_time: "9:45", user_id: 4, room_id: 2},
        ...
        {date: "09/26/2017", available: false, start_time: '7:00', end_time: "10:00", user_id: 3, room_id: 10},
        {date: "10/07/2017", available: true, start_time: '3:30', end_time: "7:30", user_id: 5, room_id: 5},
      ]);
    });
};
